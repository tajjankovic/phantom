...
!
 ...
 real :: Mintercept = 2.4e-7 !-- Intercepted mass of the disk in Msun for 1Rsun stars
...
subroutine setpart(id,npart,npartoftype,xyzh,massoftype,vxyzu,polyk,gamma,hfact,time,fileprefix)
 ...
 npart = Nparts
 sigma = Mintercept*solarm/(umass*3.14) ! should be here a factor of 2??
 total_m = sigma * 4 * W * L
 mpart = total_m / npart
 ...
 print *,'-----Central density is:', rho_0
